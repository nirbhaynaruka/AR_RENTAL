            ...
            docRef2.get().then(function (doc1) {
                if (doc1 && doc1.exists) {
                    ...
                    document.getElementById("cardetails").innerHTML =
                        ...
                        .toDateString() + '\ | Pickup date : ' + (new Date(myData.pickupDate) == "Invalid Date" ? myData.pickupDate.toDate() : new Date(myData.pickupDate)) + '\ | Drop date : ' + (new Date(myData.dropDate) == "Invalid Date" ? myData.dropDate.toDate() : new Date(myData.dropDate)) +
